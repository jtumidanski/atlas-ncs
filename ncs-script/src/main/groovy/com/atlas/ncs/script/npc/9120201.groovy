...
class NPC9120201 {
   ...
   EventManager em
   MapleExpeditionType expeditionType = MapleExpeditionType.SHOWA
         ...
         if (status == 0) {
            if (player.getLevel() < expeditionType.getMinLevel() || player.getLevel() > expeditionType.getMaxLevel()) {
               ...
               if (expedition.contains(player)) { //If you're in it but it hasn't started, be patient
                  cm.sendOk("9120201_ALREADY_REGISTERED", expedition.getLeader().getName())
            ...
            if (selection > 0) {
               ...
               cm.sendOk("9120201_YOU_HAVE_BANNED", banned.getValue())
