      ...
      if (mode < 1) {
         ...
         if (status == 0) {
            ...
            if (selection == 1) {
               ...
               if (colors.length == 0) {
                  cm.sendOk("9200100_NO_ONE_TIME_COSMETIC_LENS")
            ...
            if (beauty == 1) {
               if (cm.haveItem(5152010)) {
                  ...
                  cm.sendOk("9200100_ENJOY_NEW_LENS")

               } else {
                  cm.sendOk("9200100_MISSING_LENS_COUPON")
               ...
               if (selection == 0 && cm.getMeso() >= regularPrice) {
                  ...
                  cm.sendOk("9200100_NOT_ENOUGH_MESO")
