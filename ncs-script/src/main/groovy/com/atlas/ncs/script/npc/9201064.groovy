         ...
         if (status == 1) {
            ...
            if (beauty == 1) {
               if (cm.haveItem(5420001)) {
                  ...
                  cm.sendOk("9201064_ENJOY_NEW_STYLE")
                  ...
                  cm.sendOk("9201064_MISSING_STYLE_COUPON")
            ...
            if (beauty == 2) {
               if (cm.haveItem(5151026)) {
                  ...
                  cm.sendOk("9201064_ENJOY_NEW_COLOR")

               } else {
                  cm.sendOk("9201064_MISSING_COLOR_COUPON")
            ...
            if (beauty == 0) {
               if (selection == 0 && cm.getMeso() >= hairPrice) {
                  ...
                  cm.sendOk("9201064_NOT_ENOUGH_MESOS")
