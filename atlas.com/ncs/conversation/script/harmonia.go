...
func (r Harmonia) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Harmonia) NotPassedTrials(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("You have not yet passed my trials. I can not advance you until you do so.")
	return SendOk(l, c, m.String())
}

func (r Harmonia) DoNotBotherMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("Please don't bother me right now, I am trying to concentrate.")
	return SendOk(l, c, m.String())
}

func (r Harmonia) Marevelous(l logrus.FieldLogger, c Context) State {
...
func (r Harmonia) IfIMust(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Harmonia) Advance(l logrus.FieldLogger, c Context) State {
...
func (r Harmonia) MakeRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Harmonia) Selection(_ int32) StateProducer {
...
func (r Harmonia) ItIsDone(l logrus.FieldLogger, c Context) State {
