...
func (r ShamanRock2) Initial(l logrus.FieldLogger, c Context) State {
...
func (r ShamanRock2) ActiveShamanRock(i int, progress string) StateProducer {
...
func (r ShamanRock2) ProgressQuest(progress string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
