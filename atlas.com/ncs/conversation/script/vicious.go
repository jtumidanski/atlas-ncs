...
func (r Vicious) Initial(l logrus.FieldLogger, c Context) State {
	return r.Hello(l, c)
}
...
func (r Vicious) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.BowRefine
	case 1:
...
func (r Vicious) SingleItemConfirm(itemId uint32, requirements RefinementRequirements) StateProducer {
...
func (r Vicious) MultipleItemConfirm(itemId uint32, amount int32, requirements RefinementRequirements) StateProducer {
	quantityPrompt := func() string {
...
func (r Vicious) RefineItemConfirm(itemId uint32, amount int32, quantityPrompt func() string, requirements RefinementRequirements) StateProducer {
...
func (r Vicious) ProcessPurchase(itemId uint32, amount int8, requirements RefinementRequirements) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r Vicious) BowRefineSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) CrossbowRefineSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) GloveRefineSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) GloveUpgradeSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) MaterialRefineSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) MaterialQuantityPrompt(itemId uint32, requirements RefinementRequirements) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
...
func (r Vicious) ProcessMaterialQuantity(itemId uint32, requirements RefinementRequirements) ProcessNumber {
...
func (r Vicious) ArrowRefineSelection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Vicious) Sorry(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Sorry, but this is how I make my living. No meso, no item.")
	return SendOk(l, c, m.String())
}

func (r Vicious) NeedMoreItems(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Vicious) NotEnoughInventorySpace(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
