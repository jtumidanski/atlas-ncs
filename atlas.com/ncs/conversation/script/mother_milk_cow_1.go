...
func (r MotherMilkCow1) Initial(l logrus.FieldLogger, c Context) State {
...
func (r MotherMilkCow1) CheckAnotherCow(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("You have taken milk from this cow recently, check another cow.")
	return SendOk(l, c, m.String())
}

func (r MotherMilkCow1) ProcessEmpty(l logrus.FieldLogger, c Context) State {
...
func (r MotherMilkCow1) ProcessOneThird(l logrus.FieldLogger, c Context) State {
	character.GainItem(l)(c.CharacterId, item.MilkJugOneThird, -1)
...
func (r MotherMilkCow1) ProcessTwoThird(l logrus.FieldLogger, c Context) State {
	character.GainItem(l)(c.CharacterId, item.MilkJugTwoThird, -1)
