...
func (r ChiefTatamo) Initial(l logrus.FieldLogger, c Context) State {
	...
	return SendListSelectionExit(l, c, m.String(), r.Selection, r.ThinkCarefully)
}

func (r ChiefTatamo) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.MagicSeed
	case 1:
...
func (r ChiefTatamo) MagicSeed(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendListSelectionExit(l, c, m.String(), r.HelpSelection, r.ThinkCarefully)
}

func (r ChiefTatamo) DoSomething(l logrus.FieldLogger, c Context) State {
	//TODO
	m := message.NewBuilder().AddText("Under development...")
	return SendOk(l, c, m.String())
}

func (r ChiefTatamo) HelpSelection(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.HowMany
	}
...
func (r ChiefTatamo) ThinkCarefully(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("Please think carefully. Once you have made your decision, let me know.")
	return SendOk(l, c, m.String())
}

func (r ChiefTatamo) HowMany(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendGetNumberExit(l, c, m.String(), r.Confirm, r.ThinkCarefully, 0, 0, 100)
}

func (r ChiefTatamo) Confirm(selection int32) StateProducer {
	if selection == 0 {
	...
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendYesNo(l, c, m.String(), r.Validate(selection), r.ThinkCarefully)
	}
}

func (r ChiefTatamo) CannotSellZero(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("I can't sell you 0.")
	return SendOk(l, c, m.String())
}

func (r ChiefTatamo) Validate(amount int32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r ChiefTatamo) PleaseCheck(l logrus.FieldLogger, c Context) State {
...
func (r ChiefTatamo) Process(amount int32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r ChiefTatamo) Success(l logrus.FieldLogger, c Context) State {
