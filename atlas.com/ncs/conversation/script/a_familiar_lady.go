...
func (r AFamiliarLady) Initial(l logrus.FieldLogger, c Context) State {
...
func (r AFamiliarLady) LostInTheWoods(l logrus.FieldLogger, c Context) State {
...
func (r AFamiliarLady) Confirm(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r AFamiliarLady) Process(l logrus.FieldLogger, c Context) State {
...
func (r AFamiliarLady) Success(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
