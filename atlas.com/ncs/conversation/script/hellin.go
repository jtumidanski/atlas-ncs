...
func (r Hellin) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Hellin) IfIMust(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Hellin) Advance(l logrus.FieldLogger, c Context) State {
...
func (r Hellin) MakeRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Hellin) Selection(_ int32) StateProducer {
...
func (r Hellin) ItIsDone(l logrus.FieldLogger, c Context) State {
