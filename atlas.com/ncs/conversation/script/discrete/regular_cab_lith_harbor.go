...
func (r RegularCabLithHarbor) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r RegularCabLithHarbor) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r RegularCabLithHarbor) MoreToSee(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r RegularCabLithHarbor) WhereToGo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder()
...
func (r RegularCabLithHarbor) TruTaxiCoupon(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("I see that you have a coupon to go to Henesys. One moment, I'll bring you there right over!")
	return script.SendNext(l, c, m.String(), r.PerformTruTaxiTransaction)
}

func (r RegularCabLithHarbor) PerformTruTaxiTransaction(l logrus.FieldLogger, c script.Context) script.State {
	character.GainItem(l)(c.CharacterId, item.TruTaxiCoupon, -1)
	return script.WarpById(_map.Henesys, 0)(l, c)
}
