...
func (r RegularCabKerningCity) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r RegularCabKerningCity) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r RegularCabKerningCity) MoreToSee(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r RegularCabKerningCity) WhereToGo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder()
