...
func (r Milla) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return script.SendYesNo(l, span, c, m.String(), script.Warp(_map.EntranceToMVsLair), script.Exit())
}
