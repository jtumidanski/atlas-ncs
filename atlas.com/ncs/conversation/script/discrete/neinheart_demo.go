...
func (r NeinheartDemo) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return script.SendAcceptDecline(l, span, c, m.String(), r.WarpToEreve, r.WarpBack)
}

func (r NeinheartDemo) WarpToEreve(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return script.Warp(_map.Ereve)(l, span, c)
}

func (r NeinheartDemo) WarpBack(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	mapId := character.SavedLocation(l)(c.CharacterId, "CYGNUSINTRO")
	return script.Warp(mapId)(l, span, c)
}
