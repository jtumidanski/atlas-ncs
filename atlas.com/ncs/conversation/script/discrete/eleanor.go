...
func (r Eleanor) NoChallenging(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Eleanor) DoYouWantToFace(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendAcceptDecline(l, c, m.String(), r.Start, r.Cowards)
}

func (r Eleanor) Cowards(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Eleanor) Start(l logrus.FieldLogger, c script.Context) script.State {
