...
func (r WarriorJobInstructorExit) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r WarriorJobInstructorExit) CollectMarbles(l logrus.FieldLogger, c script.Context) script.State {
...
func (r WarriorJobInstructorExit) WarpExit(l logrus.FieldLogger, c script.Context) script.State {
	return script.WarpById(_map.WestRockyMountainIV, 2)(l, c)
}

func (r WarriorJobInstructorExit) Passed(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructorExit) Reward(l logrus.FieldLogger, c script.Context) script.State {
