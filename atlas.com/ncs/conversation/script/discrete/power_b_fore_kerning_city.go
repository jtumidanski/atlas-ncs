...
func (r PowerBForeKerningCity) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForeKerningCity) UnderLevel20(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("This training ground is available only for those under level 20.")
	return script.SendOk(l, c, m.String())
}

func (r PowerBForeKerningCity) ChooseRoom(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForeKerningCity) RoomFull(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
