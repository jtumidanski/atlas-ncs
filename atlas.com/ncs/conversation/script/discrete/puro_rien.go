...
func (r PuroRien) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r PuroRien) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PuroRien) LetMeKnow(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("OK. If you ever change your mind, please let me know.")
	return script.SendOk(l, c, m.String())
}

func (r PuroRien) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PuroRien) NotEnoughMeso(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r PuroRien) Process(l logrus.FieldLogger, c script.Context) script.State {
