...
func (r Duru) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r Duru) Selection(selection int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		if !character.HasItems(l, span)(c.CharacterId, item.ToughLeather, 100) {
...
func (r Duru) NeedAtLeast100(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r Duru) ProcessQuantity(selection int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		...
		character.GainItem(l, span)(c.CharacterId, item.ToughLeather, -selection*100)
