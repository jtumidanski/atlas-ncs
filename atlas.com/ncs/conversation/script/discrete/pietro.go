...
func (r Pietro) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.Prize)
}

func (r Pietro) Prize(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.SomethingGood)
}

func (r Pietro) SomethingGood(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Pietro) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Pietro) Process(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Pietro) MakeRoom(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
