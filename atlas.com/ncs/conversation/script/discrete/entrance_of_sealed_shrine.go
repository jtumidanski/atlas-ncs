...
func (r EntranceOfSealedShrine) Initial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("The entrance of the Sealed Shrine... ").
		BlueText().AddText("Password").
		BlackText().AddText("!")
	return script.SendGetText(l, c, m.String(), r.ProcessPassword)
}
...
func (r EntranceOfSealedShrine) CorrectButMissingPrerequisites(l logrus.FieldLogger, c script.Context) script.State {
...
func (r EntranceOfSealedShrine) AlreadyAttending(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Someone is already attending the Sealed Shrine.")
	return script.SendOk(l, c, m.String())
}

func (r EntranceOfSealedShrine) Wrong(l logrus.FieldLogger, c script.Context) script.State {
