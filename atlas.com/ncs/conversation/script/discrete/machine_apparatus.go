...
func (r MachineApparatus) Initial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Beep... beep... you can make your escape to a safer place through me. Beep... beep... would you like to leave this place?")
	return script.SendYesNo(l, c, m.String(), script.WarpById(_map.DeepInsideTheClocktower, 0), script.Exit())
}
