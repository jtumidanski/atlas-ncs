...
func (r Jeff) Initial(l logrus.FieldLogger, c script.Context) script.State {
	if character.HasItem(l)(c.CharacterId, item.OrihalconHammer) {
		return script.WarpById(_map.IceValley, 1)(l, c)
	}
	return r.FurtherAndDeeper(l, c)
}

func (r Jeff) FurtherAndDeeper(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.VerifyLevel)
}

func (r Jeff) VerifyLevel(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Jeff) ToWeak(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendPrevious(l, c, m.String(), r.FurtherAndDeeper)
}

func (r Jeff) DoYouWantTo(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendYesNo(l, c, m.String(), script.WarpById(_map.SharpCliffI, 5), r.ChangeYourMind)
}

func (r Jeff) ChangeYourMind(l logrus.FieldLogger, c script.Context) script.State {
