...
func (r Rain) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.TownCalledAmherst(l, c)
}

func (r Rain) TownCalledAmherst(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.GoToSouthPerry)
}

func (r Rain) GoToSouthPerry(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.ChooseYourJob, r.TownCalledAmherst)
}

func (r Rain) ChooseYourJob(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendPrevious(l, c, m.String(), r.GoToSouthPerry)
}