...
func (r Chris) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Chris) WhatToDo(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Chris) RefineMineral(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.RefineMineralSelection)
}

func (r Chris) RefineJewel(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.RefineJewelSelection)
}

func (r Chris) MetalHoof(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendYesNo(l, c, m.String(), r.SpecialRefinement, script.Exit())
}

func (r Chris) UpgradeClaw(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Chris) RefineMineralSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Chris) RefineJewelSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Chris) UpgradeClawSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Chris) HowMany(itemId uint32, requirements RefinementRequirements) script.StateProducer {
...
func (r Chris) QuantitySelection(itemId uint32, requirements RefinementRequirements) script.ProcessNumber {
	return func(selection int32) script.StateProducer {
		return r.ConfirmQuantity(itemId, uint32(selection), requirements)
	}
}

func (r Chris) Confirm(itemId uint32, requirements RefinementRequirements) script.StateProducer {
	return r.ConfirmQuantity(itemId, 1, requirements)
}

func (r Chris) ConfirmQuantity(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		m := message.NewBuilder().
...
func (r Chris) Validate(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Chris) PerformRefine(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
