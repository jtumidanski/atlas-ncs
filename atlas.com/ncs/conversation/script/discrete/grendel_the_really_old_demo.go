...
func (r GrendelTheReallyOldDemo) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.MagicianIntroduction(l, c)
}

func (r GrendelTheReallyOldDemo) MagicianIntroduction(l logrus.FieldLogger, c script.Context) script.State {
...
func (r GrendelTheReallyOldDemo) Demo(l logrus.FieldLogger, c script.Context) script.State {
...
func (r GrendelTheReallyOldDemo) DoDemo(l logrus.FieldLogger, c script.Context) script.State {
	npc.LockUI(l)(c.CharacterId)
	return script.WarpById(_map.MagicianDemo, 0)(l, c)
}

func (r GrendelTheReallyOldDemo) SeeMeAgain(l logrus.FieldLogger, c script.Context) script.State {
