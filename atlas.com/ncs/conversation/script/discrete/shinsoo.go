...
func (r Shinsoo) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shinsoo) GiveBlessing(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shinsoo) DoNotStop(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
