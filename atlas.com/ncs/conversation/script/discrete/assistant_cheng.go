...
func (r AssistantCheng) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r AssistantCheng) ConfirmQuit(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Do you wish to quit this stage?")
	return script.SendYesNo(l, c, m.String(), r.ProcessExit, r.CallMe)
}

func (r AssistantCheng) CallMe(l logrus.FieldLogger, c script.Context) script.State {
...
func (r AssistantCheng) ConfirmEnter(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Do you want to enter ").
		BlueText().ShowMap(_map.ToyFactorySector4).
		BlackText().AddText("?")
	return script.SendYesNo(l, c, m.String(), r.ValidateEnter, script.Exit())
}

func (r AssistantCheng) AccessRestricted(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Access to ").
		BlueText().ShowMap(_map.ToyFactorySector4).
...
func (r AssistantCheng) ValidateEnter(l logrus.FieldLogger, c script.Context) script.State {
...
func (r AssistantCheng) AlreadyAttempting(l logrus.FieldLogger, c script.Context) script.State {
