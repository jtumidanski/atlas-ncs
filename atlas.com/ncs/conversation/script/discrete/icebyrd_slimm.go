...
func (r IcebyrdSlimm) WhatUp(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) PayAttention(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Hey, pay attention, I'm trying to quiz you on another question, fam!")
	return script.SendOk(l, c, m.String())
}

func (r IcebyrdSlimm) GoodJob(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) WhatIsThisPlace(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.WhatUp)
}

func (r IcebyrdSlimm) Foxwit(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) FoxwitDoor(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) WhereAreMesoGears(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) KrakianJungle(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) GearPortal(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) AlwaysBuilding(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) JackMasque(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) Rekindled(l logrus.FieldLogger, c script.Context) script.State {
...
func (r IcebyrdSlimm) HardAtWork(l logrus.FieldLogger, c script.Context) script.State {
