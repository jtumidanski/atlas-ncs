...
func (r IcebyrdSlimm) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if quest.IsCompleted(l)(c.CharacterId, 4911) {
		return r.GoodJob(l, span, c)
	}
	if quest.IsCompleted(l)(c.CharacterId, 4900) || quest.IsStarted(l)(c.CharacterId, 4900) {
		return r.PayAttention(l, span, c)
	}
	return r.WhatUp(l, span, c)
}

func (r IcebyrdSlimm) WhatUp(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) PayAttention(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().AddText("Hey, pay attention, I'm trying to quiz you on another question, fam!")
	return script.SendOk(l, span, c, m.String())
}

func (r IcebyrdSlimm) GoodJob(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().AddText("Good job! You've solved all of my questions about NLC. Enjoy your trip!")
	return script.SendOk(l, span, c, m.String())
}

func (r IcebyrdSlimm) Selection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r IcebyrdSlimm) WhatIsThisPlace(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return script.SendNext(l, span, c, m.String(), r.WhatUp)
}

func (r IcebyrdSlimm) Foxwit(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) FoxwitDoor(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) WhereAreMesoGears(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) KrakianJungle(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) GearPortal(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) AlwaysBuilding(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) JackMasque(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) Rekindled(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) HardAtWork(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r IcebyrdSlimm) Quiz(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if character.IsLevel(l, span)(c.CharacterId, 10) {
