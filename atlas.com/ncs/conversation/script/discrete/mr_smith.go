...
func (r MrSmith) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MrSmith) WhatToDo(selection int32) script.StateProducer {
	switch selection {
	case 0:
		return r.MakeGlove
	case 1:
...
func (r MrSmith) MakeGlove(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrSmith) UpgradeGlove(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.UpgradeSelection)
}

func (r MrSmith) CreateMaterials(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrSmith) GloveSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r MrSmith) UpgradeSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r MrSmith) MaterialRefineSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r MrSmith) MaterialQuantityPrompt(itemId uint32, requirements RefinementRequirements) script.StateProducer {
...
func (r MrSmith) ProcessMaterialQuantity(itemId uint32, requirements RefinementRequirements) script.ProcessNumber {
	return func(selection int32) script.StateProducer {
		return r.ConfirmQuantity(itemId, uint32(selection), requirements)
	}
}

func (r MrSmith) Confirm(itemId uint32, requirements RefinementRequirements) script.StateProducer {
	return r.ConfirmQuantity(itemId, 1, requirements)
}

func (r MrSmith) ConfirmQuantity(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		m := message.NewBuilder().
...
func (r MrSmith) Validate(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MrSmith) PerformRefine(itemId uint32, amount uint32, requirements RefinementRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
