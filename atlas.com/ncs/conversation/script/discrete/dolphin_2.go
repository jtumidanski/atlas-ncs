...
func (r Dolphin2) Initial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Will you move to ").
		...
		BlackText().AddText(".")
	return script.SendYesNo(l, c, m.String(), r.Validate, r.TooBusy)
}

func (r Dolphin2) TooBusy(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Dolphin2) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Dolphin2) Process(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.WarpById(_map.Aquarium, 0)(l, c)
}

func (r Dolphin2) NotEnoughMeso(l logrus.FieldLogger, c script.Context) script.State {
