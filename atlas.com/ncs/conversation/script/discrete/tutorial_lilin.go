...
func (r TutorialLilin) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if c.MapId == _map.IceCave {
		if !character.AreaInfo(l)(c.CharacterId, 21019, "helper=clear") {
			return r.FinallyAwoken(l, span, c)
		} else {
			return r.AreYouAlright(l, span, c)
		}
	}
	return r.AnythingStillCurious(l, span, c)
}

func (r TutorialLilin) FinallyAwoken(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You've finally awoken...!")
	return script.SendNextSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.AndYouAre)
}

func (r TutorialLilin) AndYouAre(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("And you are...?")
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerCharacterLeft, r.TheHero, r.FinallyAwoken)
}

func (r TutorialLilin) TheHero(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("The hero who fought against the Black Magician... I've been waiting for you to wake up!")
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.WhatAreYouTalkingAbout, r.AndYouAre)
}

func (r TutorialLilin) WhatAreYouTalkingAbout(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Who... Who are you? And what are you talking about?")
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerCharacterLeft, r.AndWhoAmI, r.TheHero)
}

func (r TutorialLilin) AndWhoAmI(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("And who am I...? I can't remember anything... Ouch, my head hurts!")
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerCharacterLeft, r.ShowIntro, r.WhatAreYouTalkingAbout)
}

func (r TutorialLilin) ShowIntro(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r TutorialLilin) AreYouAlright(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Are you alright?")
	return script.SendNextSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.ICannotRemember)
}

func (r TutorialLilin) ICannotRemember(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("I can't remember anything. Where am I? And who are you...?")
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerCharacterLeft, r.StayCalm, r.AreYouAlright)
}

func (r TutorialLilin) StayCalm(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.YouAreAHero, r.ICannotRemember)
}

func (r TutorialLilin) YouAreAHero(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.ThisIsRien, r.StayCalm)
}

func (r TutorialLilin) ThisIsRien(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.MyNameIs, r.YouAreAHero)
}

func (r TutorialLilin) MyNameIs(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.SaidTooMuch, r.ThisIsRien)
}

func (r TutorialLilin) SaidTooMuch(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPreviousSpeaker(l, span, c, m.String(), npc.SpeakerUnknown, r.Warp, r.MyNameIs)
}

func (r TutorialLilin) Warp(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	character.SpawnGuide(l)(c.CharacterId)
	return script.WarpById(_map.ColdForest1, 0)(l, span, c)
}

func (r TutorialLilin) AnythingStillCurious(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r TutorialLilin) WhoAmI(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r TutorialLilin) WhereAmI(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r TutorialLilin) WhoAreYou(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r TutorialLilin) GetToTown(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
