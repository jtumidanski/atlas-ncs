...
func (r Mue) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Mue) OtherBusiness(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("You must have some business to take care of here, right?")
	return script.SendOk(l, c, m.String())
}

func (r Mue) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Mue) AreYouSure(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Mue) Process(l logrus.FieldLogger, c script.Context) script.State {
