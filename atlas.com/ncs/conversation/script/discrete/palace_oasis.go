...
func (r PalaceOasis) FloatingInRiver(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PalaceOasis) LockOfHair(l logrus.FieldLogger, c script.Context) script.State {
	if !character.CanHold(l)(c.CharacterId, item.TigunTransformationBundle) {
