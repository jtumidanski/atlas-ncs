...
func (r AthenaPierce) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r AthenaPierce) FirstJobInitial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r AthenaPierce) FirstJobRequirementCheck(l logrus.FieldLogger, c script.Context) script.State {
	if character.MeetsCriteria(l)(c.CharacterId, character.IsLevelCriteria(10), character.HasDexterityCriteria(25)) {
		...
		return script.SendNextPrevious(l, c, m.String(), r.AwardFirstJob, r.FirstJobInitial)
	}
...
func (r AthenaPierce) AwardFirstJob(l logrus.FieldLogger, c script.Context) script.State {
