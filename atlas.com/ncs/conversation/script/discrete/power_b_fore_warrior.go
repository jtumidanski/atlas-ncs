...
func (r PowerBForeWarrior) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForeWarrior) UnderLevel20(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("This training ground is available only for those under level 20.")
	return script.SendOk(l, c, m.String())
}

func (r PowerBForeWarrior) ChooseRoom(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForeWarrior) RoomFull(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
