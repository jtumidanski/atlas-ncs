...
func (r RobertHolly) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendYesNo(l, c, m.String(), r.Alright, r.ISee)
}

func (r RobertHolly) ISee(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r RobertHolly) Alright(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendYesNo(l, c, m.String(), r.Validate, r.NotAsManyFriends)
}

func (r RobertHolly) Validate(l logrus.FieldLogger, c script.Context) script.State {
	if character.BuddyCapacity(l)(c.CharacterId) >= 50 || !character.HasMeso(l)(c.CharacterId, 240000) {
		return r.AreYouSure(l, c)
	}
	return r.Process(l, c)
}

func (r RobertHolly) AreYouSure(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r RobertHolly) Process(l logrus.FieldLogger, c script.Context) script.State {
...
func (r RobertHolly) NotAsManyFriends(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
