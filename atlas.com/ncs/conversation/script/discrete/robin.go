...
func (r Robin) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.AskMeAnything(l, c)
}

func (r Robin) AskMeAnything(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		...
		BlackText()
	return script.SendListSelection(l, c, m.String(), r.ProcessListSelection)
}
...
func (r Robin) HowToMove(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.AttackMonsters)
}

func (r Robin) HowToTakeDownMonster(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.JobAdvancement)

}

func (r Robin) HowToGather(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.FullInventory)
}

func (r Robin) WhenYouDie(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.BeginnerDeath)

}

func (r Robin) ChoosingAJob(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.HowToAdvance)

}

func (r Robin) TheIsland(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.PowerfulPlayer)

}

func (r Robin) WarriorToDo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.AskMeAnything)

}

func (r Robin) BowmanToDo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Robin) MagicianToDo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You want to become a ").
	...
	return script.SendNext(l, c, m.String(), r.MagicianSpecial)

}

func (r Robin) ThiefToDo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You want to become a ").
...
func (r Robin) RaiseStats(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.AbilityExplanation)

}

func (r Robin) CheckItems(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Robin) WearItems(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Robin) CheckEquipment(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Robin) SpecialAbilities(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Robin) GetToVictoria(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.OneLastPiece)

}

func (r Robin) Mesos(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Robin) AttackMonsters(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.HowToMove)
}

func (r Robin) JobAdvancement(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.HowToTakeDownMonster)
}

func (r Robin) FullInventory(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.HowToGather)
}

func (r Robin) BeginnerDeath(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.WhenYouDie)
}

func (r Robin) HowToAdvance(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.ChoosingAJob)
}

func (r Robin) PowerfulPlayer(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.TheIsland)
}

func (r Robin) MagicianSpecial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.MagicianToDo)
}

func (r Robin) AbilityExplanation(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.RaiseStats)
}

func (r Robin) OneLastPiece(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.AskMeAnything, r.GetToVictoria)
}
