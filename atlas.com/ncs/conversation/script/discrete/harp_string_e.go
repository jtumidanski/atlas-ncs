...
// HarpStringE is located in Hidden Street - Eliza's Garden (920020000)
type HarpStringE struct {
}

func (r HarpStringE) NPCId() uint32 {
	return npc.HarpStringE
}

func (r HarpStringE) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
