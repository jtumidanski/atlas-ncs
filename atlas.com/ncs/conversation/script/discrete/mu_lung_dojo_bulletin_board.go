...
func (r MuLungDojoBulletinBoard) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MuLungDojoBulletinBoard) Challenge(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendYesNo(l, c, m.String(), r.Warp, r.No)
}

func (r MuLungDojoBulletinBoard) No(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MuLungDojoBulletinBoard) Warp(l logrus.FieldLogger, c script.Context) script.State {
	character.SaveLocation(l)(c.CharacterId, "MIRROR")
	return script.WarpById(_map.MuLungDojoEntrance, 4)(l, c)
}

func (r MuLungDojoBulletinBoard) Detail(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.CallYourFriends)
}

func (r MuLungDojoBulletinBoard) CallYourFriends(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendPrevious(l, c, m.String(), r.Detail)
}
