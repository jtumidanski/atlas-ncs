...
func (r Tommie) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Tommie) Process(l logrus.FieldLogger, c script.Context) script.State {
	character.GainItem(l)(c.CharacterId, item.TicketToOrbisRegular, -1)
	return script.WarpById(_map.BeforeTakeoffToOrbisFromLeafre, 0)(l, c)
}
