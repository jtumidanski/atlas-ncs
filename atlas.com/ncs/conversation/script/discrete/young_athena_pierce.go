...
func (r YoungAthenaPierce) Initial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Aran, you're awake! How are you feeling? Hm? You want to know what's been going on?")
	return script.SendNext(l, c, m.String(), r.AlmostDone)
}

func (r YoungAthenaPierce) AlmostDone(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.OtherHeroes)
}

func (r YoungAthenaPierce) OtherHeroes(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.ShowTrio)
}

func (r YoungAthenaPierce) ShowTrio(l logrus.FieldLogger, c script.Context) script.State {
