...
func (r ChiefTatamo) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return script.SendListSelectionExit(l, span, c, m.String(), r.Selection, r.ThinkCarefully)
}
...
func (r ChiefTatamo) MagicSeed(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelectionExit(l, span, c, m.String(), r.HelpSelection, r.ThinkCarefully)
}

func (r ChiefTatamo) DoSomething(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	//TODO
...
func (r ChiefTatamo) ThinkCarefully(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().AddText("Please think carefully. Once you have made your decision, let me know.")
	return script.SendOk(l, span, c, m.String())
}

func (r ChiefTatamo) HowMany(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendGetNumberExit(l, span, c, m.String(), r.Confirm, r.ThinkCarefully, 0, 0, 100)
}
...
func (r ChiefTatamo) Confirm(selection int32) script.StateProducer {
	...
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		...
		return script.SendYesNo(l, span, c, m.String(), r.Validate(selection), r.ThinkCarefully)
	}
}

func (r ChiefTatamo) CannotSellZero(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r ChiefTatamo) Validate(amount int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		if !character.HasMeso(l, span)(c.CharacterId, uint32(amount)) || !character.CanHoldAll(l)(c.CharacterId, item.MagicSeed, uint32(amount)) {
			return r.PleaseCheck(l, span, c)
		}
		return r.Process(amount)(l, span, c)
	}
}

func (r ChiefTatamo) PleaseCheck(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r ChiefTatamo) Process(amount int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		character.GainMeso(l, span)(c.CharacterId, -amount)
		character.GainItem(l, span)(c.CharacterId, item.MagicSeed, amount)
		return r.Success(l, span, c)
	}
}

func (r ChiefTatamo) Success(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
