...
func (r DancesWithBalrogDemo) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return r.WarriorIntroduction(l, span, c)
}

func (r DancesWithBalrogDemo) WarriorIntroduction(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r DancesWithBalrogDemo) Demo(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r DancesWithBalrogDemo) DoDemo(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
    npc.LockUI(l)(c.CharacterId)
    return script.WarpById(_map.WarriorDemo, 0)(l, span, c)
}

func (r DancesWithBalrogDemo) SeeMeAgain(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
