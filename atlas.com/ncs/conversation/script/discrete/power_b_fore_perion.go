...
func (r PowerBForePerion) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForePerion) UnderLevel20(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("This training ground is available only for those under level 20.")
	return script.SendOk(l, c, m.String())
}

func (r PowerBForePerion) ChooseRoom(l logrus.FieldLogger, c script.Context) script.State {
...
func (r PowerBForePerion) RoomFull(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
