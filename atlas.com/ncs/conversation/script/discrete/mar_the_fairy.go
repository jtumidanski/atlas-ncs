...
func (r MarTheFairy) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r MarTheFairy) Hello(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendYesNo(l, c, m.String(), r.ValidateEvolve, r.SeeYouNextTime)
}

func (r MarTheFairy) SeeYouNextTime(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Alright, see you next time.")
	return script.SendOk(l, c, m.String())
}

func (r MarTheFairy) ValidateEvolve(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MarTheFairy) Hatched(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("I don't know how you got that egg, but it has hatched, apparently!")
	return script.SendOk(l, c, m.String())
}

func (r MarTheFairy) PetInSlotOne(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Make sure your pet is equipped on slot 1.")
	return script.SendOk(l, c, m.String())
}

func (r MarTheFairy) DoesNotMeetRequirements(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MarTheFairy) NotLeveledEnough(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Your pet must be level 15 or above to evolve.")
	return script.SendOk(l, c, m.String())
}

func (r MarTheFairy) MultipleItem(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.ProcessRemoval)
}
...
func (r MarTheFairy) NoThanks(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Okay, come back next time.")
	return script.SendOk(l, c, m.String())
}

func (r MarTheFairy) RemoveFirstDragon(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MarTheFairy) RemoveFirstCashSlot(l logrus.FieldLogger, c script.Context) script.State {
...
func (r MarTheFairy) NotReady(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
