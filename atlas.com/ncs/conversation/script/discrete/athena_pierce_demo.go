...
func (r AthenaPierceDemo) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return r.BowmanIntroduction(l, span, c)
}

func (r AthenaPierceDemo) BowmanIntroduction(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r AthenaPierceDemo) Demo(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r AthenaPierceDemo) DoDemo(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	npc.LockUI(l)(c.CharacterId)
	return script.WarpById(_map.BowmanDemo, 0)(l, span, c)
}

func (r AthenaPierceDemo) SeeMeAgain(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
