...
func (r Paul) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Paul) WhatKind(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) AllThisMonth(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) Explanation(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) Go(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) OlaOla(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) Fitness(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) Snowball(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) Coconut(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) OxQuiz(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Paul) TreasureHunt(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
