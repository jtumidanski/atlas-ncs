...
func (r Spinel) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Spinel) TravelHello(mapId uint32, fee int) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		m := message.NewBuilder().
			...
			BlackText().AddText("!")
		return script.SendNext(l, c, m.String(), r.CurrentlyOffer(mapId, fee))
	}
}

func (r Spinel) TravelingHello(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendListSelection(l, c, m.String(), r.TravelingSelection(mapId))
}
...
func (r Spinel) AlrightHome(mapId uint32) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNext(l, c, m.String(), r.WarpBack(mapId))
	}
}
...
func (r Spinel) LetMeKnow(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Spinel) CurrentlyOfferMushroomShrine(mapId uint32, fee int) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendListSelection(l, c, m.String(), r.ConfirmMushroomShrine(mapId, fee))
	}
}
...
func (r Spinel) ConfirmMushroomShrine(mapId uint32, fee int) script.ProcessSelection {
	return func(selection int32) script.StateProducer {
		return func(l logrus.FieldLogger, c script.Context) script.State {
			...
			return script.SendYesNo(l, c, m.String(), r.Validate(fee, r.CheckoutMushroomShrine(mapId, fee)), script.Exit())
		}
	}
}
...
func (r Spinel) CurrentlyOfferMalaysia(mapId uint32, fee int) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendListSelection(l, c, m.String(), r.ConfirmMalaysia(mapId, fee))
	}
}
...
func (r Spinel) ConfirmMalaysia(mapId uint32, fee int) script.ProcessSelection {
	return func(selection int32) script.StateProducer {
		return func(l logrus.FieldLogger, c script.Context) script.State {
			...
			return script.SendYesNo(l, c, m.String(), r.Validate(fee, r.CheckoutMalaysia(mapId, fee)), script.Exit())
		}
	}
}
...
func (r Spinel) NotEnoughMeso(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Spinel) CheckoutMushroomShrine(mapId uint32, fee int) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNext(l, c, m.String(), r.Process(mapId, fee))
	}
}
