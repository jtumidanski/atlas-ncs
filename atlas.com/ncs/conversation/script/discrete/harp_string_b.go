...
// HarpStringB is located in Hidden Street - Eliza's Garden (920020000)
type HarpStringB struct {
}

func (r HarpStringB) NPCId() uint32 {
	return npc.HarpStringB
}

func (r HarpStringB) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
