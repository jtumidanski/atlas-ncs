...
func (r RegularCabHenesys) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r RegularCabHenesys) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r RegularCabHenesys) MoreToSee(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r RegularCabHenesys) WhereToGo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder()
