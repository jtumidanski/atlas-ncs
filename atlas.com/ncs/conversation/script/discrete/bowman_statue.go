...
func (r BowmanStatue) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendYesNoExit(l, c, m.String(), script.WarpById(_map.BowmanInstructionalSchool, 0), r.ComeBack, r.ComeBack)
}

func (r BowmanStatue) ComeBack(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
