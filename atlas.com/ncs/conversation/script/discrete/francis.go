...
func (r Francis) Initial(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("What the... you don't belong here!")
	return script.SendNext(l, c, m.String(), r.StartEvent)
}

func (r Francis) StartEvent(l logrus.FieldLogger, c script.Context) script.State {
