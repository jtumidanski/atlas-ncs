...
func (r BabyMilkCow1) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r BabyMilkCow1) RemainsEmpty(l logrus.FieldLogger, c script.Context) script.State {
...
func (r BabyMilkCow1) EmptyBottle(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
