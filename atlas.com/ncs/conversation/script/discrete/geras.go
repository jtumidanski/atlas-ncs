...
func (r Geras) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Geras) MissingTicket(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Make sure you got an Ariant ticket to travel in this genie. Check your inventory.")
	return script.SendOk(l, c, m.String())
}

func (r Geras) BePatient(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Geras) Confirm(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Geras) Validate(l logrus.FieldLogger, c script.Context) script.State {
	if !character.TransportBoarding(l)(c.CharacterId, _map.StationToAriant, _map.AriantStationPlatform) {
		return r.BePatient(l, c)
	}
...
func (r Geras) Process(l logrus.FieldLogger, c script.Context) script.State {
	character.GainItem(l)(c.CharacterId, item.TicketToAriantRegular, -1)
	return script.WarpById(_map.StationToAriant2, 0)(l, c)
}

func (r Geras) ChangeYourMind(l logrus.FieldLogger, c script.Context) script.State {
