...
func (r Shalon) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shalon) Buy(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shalon) Warp(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendYesNo(l, c, m.String(), r.ValidateWarp, script.Exit())
}

func (r Shalon) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shalon) ProcessPurchase(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Shalon) ThankYou(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Thank you for choosing Wizet Airline! Enjoy your flight!")
	return script.SendOk(l, c, m.String())
}

func (r Shalon) ValidateWarp(l logrus.FieldLogger, c script.Context) script.State {
	...
	character.GainItem(l)(c.CharacterId, item.TicketToKerningCityFromCBD, -1)
	return script.Warp(_map.BeforeDepartureToKerningCity)(l, c)
}

func (r Shalon) MissingTicket(l logrus.FieldLogger, c script.Context) script.State {
