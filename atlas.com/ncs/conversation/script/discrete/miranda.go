...
func (r Miranda) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	hello := message.NewBuilder().
		...
		String()
	return care.NewGenericSkinCare(item.NLCSkinCoupon, hello)(l, span, c)
}
