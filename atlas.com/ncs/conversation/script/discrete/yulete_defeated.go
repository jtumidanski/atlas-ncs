...
func (r YuleteDefeated) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r YuleteDefeated) Process(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if !quest.IsCompleted(l)(c.CharacterId, 7770) {
		quest.Complete(l)(c.CharacterId, 7770)
	}
	return script.WarpById(_map.RomeoAndJuliet, 0)(l, span, c)
}
