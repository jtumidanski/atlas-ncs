...
func (r WarriorJobInstructor) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r WarriorJobInstructor) TrueHero(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You're truly a hero!")
	return script.SendOk(l, span, c, m.String())
}

func (r WarriorJobInstructor) LetYouIn(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) Warp(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return script.WarpById(_map.WarriorsRockyMountain, 0)(l, span, c)
}

func (r WarriorJobInstructor) ExplainTest(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) SendYou(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) AcquireMarble(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) CannotLeave(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) Begin(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r WarriorJobInstructor) OnceYouAreReady(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
