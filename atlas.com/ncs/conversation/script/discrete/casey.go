...
func (r Casey) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r Casey) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Casey) MakeMiniGame(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.MiniGameProducer)
}
...
func (r Casey) LearnMore(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.LearnMoreProducer)
}
...
func (r Casey) OmokRules(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.OmokCost)
}

func (r Casey) MatchCardRules(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.MatchCardCost)
}

func (r Casey) OmokCost(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.HowToStart(r.OmokStart, r.OmokCost), r.OmokRules)
}

func (r Casey) MatchCardCost(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		...
		BlueText().AddText("A set of Match Cards").
		BlackText().AddText(", you can enter the room and play. However, if you don't possess 100 mesos, then you won't be allowed to enter in the room at all. The person opening the game room also needs 100 mesos to open the room (or else there's no game). If you run out of mesos during the game, then you're automatically kicked out of the room!")
	return script.SendNextPrevious(l, c, m.String(), r.HowToStart(r.MatchCardStart, r.MatchCardCost), r.MatchCardRules)
}
...
func (r Casey) HowToStart(next script.StateProducer, previous script.StateProducer) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNextPrevious(l, c, m.String(), next, previous)
	}
}

func (r Casey) OmokStart(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.RedoOrTie, r.HowToStart(r.OmokStart, r.OmokCost))
}

func (r Casey) MatchCardStart(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.MoveOnTime, r.HowToStart(r.MatchCardStart, r.MatchCardCost))
}

func (r Casey) RedoOrTie(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.NextGame(r.RedoOrTie), r.OmokStart)
}

func (r Casey) MoveOnTime(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.LongerStreak, r.MatchCardStart)
}
...
func (r Casey) NextGame(previous script.StateProducer) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendPrevious(l, c, m.String(), previous)
	}
}

func (r Casey) LongerStreak(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.NextGame(r.LongerStreak), r.MoveOnTime)
}

func (r Casey) MakeOmok(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.WhichSet)
}

func (r Casey) WhichSet(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.OmokSetSelection)
}
...
func (r Casey) MakeMatchCards(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Casey) MatchCardNeeds(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You want ").
		BlueText().AddText("A set of Match Cards").
...
func (r Casey) ProcessMatchCardCreation(l logrus.FieldLogger, c script.Context) script.State {
