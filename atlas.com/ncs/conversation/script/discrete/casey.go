...
func (r Casey) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return r.Hello(l, span, c)
}

func (r Casey) Hello(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r Casey) Selection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Casey) MakeMiniGame(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, span, c, m.String(), r.MiniGameProducer)
}

func (r Casey) MiniGameProducer(selection int32) script.StateProducer {
	switch selection {
	case 0:
		return r.MakeOmok
	case 1:
...
func (r Casey) LearnMore(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, span, c, m.String(), r.LearnMoreProducer)
}

func (r Casey) LearnMoreProducer(selection int32) script.StateProducer {
	switch selection {
	case 0:
		return r.OmokRules
	case 1:
...
func (r Casey) OmokRules(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, span, c, m.String(), r.OmokCost)
}

func (r Casey) MatchCardRules(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, span, c, m.String(), r.MatchCardCost)
}

func (r Casey) OmokCost(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.HowToStart(r.OmokStart, r.OmokCost), r.OmokRules)
}

func (r Casey) MatchCardCost(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		...
		BlueText().AddText("A set of Match Cards").
		BlackText().AddText(", you can enter the room and play. However, if you don't possess 100 mesos, then you won't be allowed to enter in the room at all. The person opening the game room also needs 100 mesos to open the room (or else there's no game). If you run out of mesos during the game, then you're automatically kicked out of the room!")
	return script.SendNextPrevious(l, span, c, m.String(), r.HowToStart(r.MatchCardStart, r.MatchCardCost), r.MatchCardRules)
}

func (r Casey) HowToStart(next script.StateProducer, previous script.StateProducer) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		...
		return script.SendNextPrevious(l, span, c, m.String(), next, previous)
	}
}

func (r Casey) OmokStart(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.RedoOrTie, r.HowToStart(r.OmokStart, r.OmokCost))
}

func (r Casey) MatchCardStart(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.MoveOnTime, r.HowToStart(r.MatchCardStart, r.MatchCardCost))
}

func (r Casey) RedoOrTie(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.NextGame(r.RedoOrTie), r.OmokStart)
}

func (r Casey) MoveOnTime(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.LongerStreak, r.MatchCardStart)
}

func (r Casey) NextGame(previous script.StateProducer) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		m := message.NewBuilder().
		...
		return script.SendPrevious(l, span, c, m.String(), previous)
	}
}

func (r Casey) LongerStreak(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, span, c, m.String(), r.NextGame(r.LongerStreak), r.MoveOnTime)
}

func (r Casey) MakeOmok(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, span, c, m.String(), r.WhichSet)
}

func (r Casey) WhichSet(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, span, c, m.String(), r.OmokSetSelection)
}

func (r Casey) OmokSetSelection(selection int32) script.StateProducer {
	switch selection {
	case 0:
...
func (r Casey) GetTheMaterials(itemId uint32, requirement1 uint32, requirement2 uint32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		m := message.NewBuilder().
...
func (r Casey) ProcessSelection(itemId uint32, requirements SetRequirements) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		for _, req := range requirements.requirements {
			if !character.HasItem(l, span)(c.CharacterId, req.itemId) {
				return r.GetTheMaterials(itemId, requirements.requirements[0].itemId, requirements.requirements[1].itemId)(l, span, c)
			}
		}
		if !character.HasItem(l, span)(c.CharacterId, item.OmokTable) {
			return r.GetTheMaterials(itemId, requirements.requirements[0].itemId, requirements.requirements[1].itemId)(l, span, c)
		}

		character.GainItem(l, span)(c.CharacterId, requirements.requirements[0].itemId, -99)
		character.GainItem(l, span)(c.CharacterId, requirements.requirements[1].itemId, -99)
		character.GainItem(l, span)(c.CharacterId, item.OmokTable, -1)
...
func (r Casey) MakeMatchCards(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if !character.HasItems(l, span)(c.CharacterId, item.MonsterCard, 15) {
		return r.MatchCardNeeds(l, span, c)
	}
	return r.ProcessMatchCardCreation(l, span, c)
}

func (r Casey) MatchCardNeeds(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You want ").
		BlueText().AddText("A set of Match Cards").
...
func (r Casey) ProcessMatchCardCreation(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	character.GainItem(l, span)(c.CharacterId, item.MonsterCard, -15)
	character.GainItem(l, span)(c.CharacterId, item.ASetOfMatchCards, 1)
	return script.Exit()(l, span, c)
}
