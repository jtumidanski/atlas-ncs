...
func (r Perzen) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Perzen) NeedAtLeast100(l logrus.FieldLogger, c script.Context) script.State {
