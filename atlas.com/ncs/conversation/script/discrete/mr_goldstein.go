...
func (r MrGoldstein) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	return r.ExtendBuddyList(l, span, c)
}

func (r MrGoldstein) ExtendBuddyList(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return script.SendYesNo(l, span, c, m.String(), r.OkGood, r.QuickExit)
}

func (r MrGoldstein) QuickExit(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrGoldstein) OkGood(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendYesNo(l, span, c, m.String(), r.ConfirmPayment, r.Exit)
}

func (r MrGoldstein) Exit(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrGoldstein) ConfirmPayment(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	if !character.HasMeso(l, span)(c.CharacterId, 240000) || !(character.BuddyCapacity(l)(c.CharacterId) >= 50) {
		return r.AreYouSure(l, span, c)
	}
	return r.ProcessPayment(l, span, c)
}

func (r MrGoldstein) AreYouSure(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrGoldstein) ProcessPayment(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	...
	return r.SendSuccess(l, span, c)
}

func (r MrGoldstein) SendSuccess(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r MrGoldstein) Error(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
	m := message.NewBuilder().
