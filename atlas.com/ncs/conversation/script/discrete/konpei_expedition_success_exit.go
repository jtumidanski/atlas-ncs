...
func (r KonpeiExpeditionSuccessExit) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), script.Warp(_map.ShowaTown))
}
