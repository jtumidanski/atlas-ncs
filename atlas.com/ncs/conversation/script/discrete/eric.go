...
func (r Eric) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return care.NewGenericCare(r.Hello(), []care.ChoiceConfig{r.StyleHair(item.CBDHairStyleCouponVIP), care.ColorCareChoice(item.CBDHairColorCouponVIP)})(l, c)
}
