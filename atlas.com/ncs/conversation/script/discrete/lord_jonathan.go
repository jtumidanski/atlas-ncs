...
func (r LordJonathan) BotherSomeoneElse(l logrus.FieldLogger, c script.Context) script.State {
...
func (r LordJonathan) FirstQuestion(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.IssueFirstQuestion)
}

func (r LordJonathan) IssueFirstQuestion(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendGetText(l, c, m.String(), r.OctopiResponse)
}
...
func (r LordJonathan) NotRight(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r LordJonathan) NextQuestion(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.TestOfWill)
}

func (r LordJonathan) TestOfWill(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.TruePirate, r.NextQuestion)
}

func (r LordJonathan) TruePirate(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.StartBartEvent, r.TestOfWill)
}

func (r LordJonathan) StartBartEvent(l logrus.FieldLogger, c script.Context) script.State {
...
func (r LordJonathan) AnotherPlayerChallenging(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r LordJonathan) Impressive(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.AirStrike)
}

func (r LordJonathan) AirStrike(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Notify us using the skill Air Strike, and we will be there to help you out, because that's what friends are for.")
	return script.SendNextPrevious(l, c, m.String(), r.Passed, r.Impressive)
}

func (r LordJonathan) Passed(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("You have met all my challenges, and passed! Good job!")
	return script.SendNextPrevious(l, c, m.String(), script.Exit(), r.AirStrike)
}
