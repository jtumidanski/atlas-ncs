...
func (r KiruOrbis) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendListSelectionExit(l, c, m.String(), r.DestinationSelection, r.LetMeKnow)
}

func (r KiruOrbis) LetMeKnow(l logrus.FieldLogger, c script.Context) script.State {
...
func (r KiruOrbis) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r KiruOrbis) NotEnoughMeso(l logrus.FieldLogger, c script.Context) script.State {
...
func (r KiruOrbis) Process(l logrus.FieldLogger, c script.Context) script.State {
	err := character.GainMeso(l)(c.CharacterId, -1000)
	if err != nil {
		l.WithError(err).Errorf("Unable to process payment by character %d.", c.CharacterId)
	}
	return script.Warp(_map.EmpressRoadToEreveFromOrbis)(l, c)
}
