...
func (r Karcasa) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.PleaseRemember)
}

func (r Karcasa) PleaseRemember(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendYesNo(l, c, m.String(), r.Validate, r.Scared)
}

func (r Karcasa) Scared(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Karcasa) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Karcasa) OkGetReady(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Okay, ready to takeoff~")
	return script.SendNext(l, c, m.String(), r.Process)
}

func (r Karcasa) ShortOnCash(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Karcasa) Process(l logrus.FieldLogger, c script.Context) script.State {
