...
func (r DangerZoneTaxi) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.Confirm(destinationId, destinationCost))
}
...
func (r DangerZoneTaxi) Confirm(mapId uint32, cost uint32) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		m := message.NewBuilder().
			...
			BlackText().AddText("?")
		return script.SendYesNo(l, c, m.String(), r.Validate(mapId, cost), r.NotCheap)
	}
}
...
func (r DangerZoneTaxi) NotEnoughMesos(l logrus.FieldLogger, c script.Context) script.State {
...
func (r DangerZoneTaxi) NotCheap(l logrus.FieldLogger, c script.Context) script.State {
