...
func (r Jean) Initial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.WhatShouldIDo)
}

func (r Jean) WhatShouldIDo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNextPrevious(l, c, m.String(), r.GoWithMe, r.Initial)
}

func (r Jean) GoWithMe(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Event(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Explanation(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.Game)
}
...
func (r Jean) OlaOla(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Fitness(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Snowball(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Coconut(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) OxQuiz(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) TreasureHunt(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r Jean) Go(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Jean) NotYetStarted(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
