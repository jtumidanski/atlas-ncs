...
func (r Irene) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Irene) Buy(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Irene) Warp(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Irene) Validate(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Irene) ProcessPurchase(l logrus.FieldLogger, c script.Context) script.State {
...
func (r Irene) ThankYou(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().AddText("Thank you for choosing Wizet Airline! Enjoy your flight!")
	return script.SendOk(l, c, m.String())
}

func (r Irene) ValidateWarp(l logrus.FieldLogger, c script.Context) script.State {
	...
	character.GainItem(l)(c.CharacterId, item.TicketToSingaporeFromKerningCity, -1)
	return script.Warp(_map.KerningAirport)(l, c)
}

func (r Irene) MissingTicket(l logrus.FieldLogger, c script.Context) script.State {
