...
// HarpStringG is located in Hidden Street - Eliza's Garden (920020000)
type HarpStringG struct {
}

func (r HarpStringG) NPCId() uint32 {
	return npc.HarpStringG
}

func (r HarpStringG) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
