...
func (r VIPCabEllinia) Initial(l logrus.FieldLogger, c script.Context) script.State {
	return r.Hello(l, c)
}

func (r VIPCabEllinia) Hello(l logrus.FieldLogger, c script.Context) script.State {
...
func (r VIPCabEllinia) MoreToOffer(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r VIPCabEllinia) Cost(l logrus.FieldLogger, c script.Context) script.State {
...
func (r VIPCabEllinia) BeginnerCost(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r VIPCabEllinia) RegularCost(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r VIPCabEllinia) NotEnoughMeso(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
