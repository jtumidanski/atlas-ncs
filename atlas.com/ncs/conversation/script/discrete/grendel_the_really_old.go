...
func (r GrendelTheReallyOld) Initial(l logrus.FieldLogger, c script.Context) script.State {
...
func (r GrendelTheReallyOld) FirstJobInitial(l logrus.FieldLogger, c script.Context) script.State {
	...
	return script.SendNext(l, c, m.String(), r.FirstJobRequirementCheck)
}

func (r GrendelTheReallyOld) FirstJobRequirementCheck(l logrus.FieldLogger, c script.Context) script.State {
	if character.MeetsCriteria(l)(c.CharacterId, character.IsLevelCriteria(8), character.HasIntelligenceCriteria(20)) {
		...
		return script.SendYesNo(l, c, m.String(), r.AwardFirstJob, r.FirstJobInitial)
	}
...
func (r GrendelTheReallyOld) AwardFirstJob(l logrus.FieldLogger, c script.Context) script.State {
...
func (r GrendelTheReallyOld) SecondJobNextStep(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("I see you have done well. I will allow you to take the next step on your long road.")
	return script.SendNext(l, c, m.String(), r.SecondJobPathInfo)
}

func (r GrendelTheReallyOld) SecondJobPathInfo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.SecondJobPathSelection)
}
...
func (r GrendelTheReallyOld) FirePoisonWizardInfo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendNext(l, c, m.String(), r.SecondJobNextStep)
}

func (r GrendelTheReallyOld) IceLightningWizardInfo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Magicians that master ").
...
func (r GrendelTheReallyOld) ClericInfo(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
		AddText("Magicians that master ").
...
func (r GrendelTheReallyOld) SecondJobChoice(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
	...
	return script.SendListSelection(l, c, m.String(), r.SecondJobSelection)
}
...
func (r GrendelTheReallyOld) ConfirmSecondJob(jobId uint16, jobName string) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendYesNo(l, c, m.String(), r.PerformSecondJobAdvancement(jobId, jobName), r.SecondJobChoice)
	}
}
...
func (r GrendelTheReallyOld) SecondJobAdvancementSuccess(jobName string) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNext(l, c, m.String(), r.SecondJobSkillBook(jobName))
	}
}
...
func (r GrendelTheReallyOld) SecondJobSkillBook(jobName string) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNextPrevious(l, c, m.String(), r.SecondJobSP(jobName), r.SecondJobAdvancementSuccess(jobName))
	}
}
...
func (r GrendelTheReallyOld) SecondJobSP(jobName string) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNextPrevious(l, c, m.String(), r.NeedToBeStrong(jobName), r.SecondJobSkillBook(jobName))
	}
}
...
func (r GrendelTheReallyOld) NeedToBeStrong(jobName string) script.StateProducer {
	return func(l logrus.FieldLogger, c script.Context) script.State {
		...
		return script.SendNextPrevious(l, c, m.String(), script.Exit(), r.SecondJobSP(jobName))
	}
}

func (r GrendelTheReallyOld) GoSeeInstructor(l logrus.FieldLogger, c script.Context) script.State {
	m := message.NewBuilder().
...
func (r GrendelTheReallyOld) Astonishing(l logrus.FieldLogger, c script.Context) script.State {
...
func (r GrendelTheReallyOld) TakeThisLetter(l logrus.FieldLogger, c script.Context) script.State {
	if !character.HasItem(l)(c.CharacterId, item.GrendelTheReallyOldsLetter) {
