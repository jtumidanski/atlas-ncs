...
func (r Loha) Initial(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r Loha) Selection(selection int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		if !character.HasItems(l, span)(c.CharacterId, item.BlackMushroomSpore, 100) {
...
func (r Loha) NeedAtLeast100(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
...
func (r Loha) ProcessQuantity(selection int32) script.StateProducer {
	return func(l logrus.FieldLogger, span opentracing.Span, c script.Context) script.State {
		...
		character.GainItem(l, span)(c.CharacterId, item.BlackMushroomSpore, -selection*100)
