...
func (r Asia) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Asia) SeeMySister(l logrus.FieldLogger, c Context) State {
...
func (r Asia) FilledWithDespair(l logrus.FieldLogger, c Context) State {
