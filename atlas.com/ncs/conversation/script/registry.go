...
func initRegistry() *Registry {
	...
	s.addConversation(AstarothsDoorway{})
	...
	s.addConversation(BowmanStatue{})
	...
	s.addConversation(DaveAndIris{})
	s.addConversation(DemonsDoorwayEastHenesys{})
	s.addConversation(DemonsDoorwayEllinia{})
	s.addConversation(DemonsDoorwayHenesys{})
	s.addConversation(DemonsDoorwayKerningCity{})
	s.addConversation(DemonsDoorwayPerion{})
	...
	s.addConversation(EnigmaTombstone{})
	...
	s.addConversation(IcebyrdSlimm{})
	...
	s.addConversation(JohnBarricade{})
	...
	s.addConversation(MagicianStatue{})
	...
	s.addConversation(GenericSkinCare{MsTan{}})
	...
	s.addConversation(GenericSkinCare{Naran{}})
	...
	s.addConversation(NLCTaxi{})
	s.addConversation(Nuris{})
	s.addConversation(OldManTom{})
	...
	s.addConversation(PirateStatue{})
	...
	s.addConversation(ProfessorFoxwit{})
	...
	s.addConversation(GenericSkinCare{Romi{}})
	s.addConversation(Roodolph{})
	...
	s.addConversation(Sage{})
	s.addConversation(Sage2{})
	s.addConversation(Samuel{})
	s.addConversation(Santa2{})
	...
	s.addConversation(SunstoneGrave{})
