...
func (r StaffSeargantCharlie) Initial(l logrus.FieldLogger, c Context) State {
	return r.Hello(l, c)
}

func (r StaffSeargantCharlie) Hello(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.DealIsSimple)
}

func (r StaffSeargantCharlie) DealIsSimple(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNo(l, c, m.String(), r.Choices, r.ShouldNotBeBad)
}

func (r StaffSeargantCharlie) ShouldNotBeBad(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r StaffSeargantCharlie) Choices(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r StaffSeargantCharlie) Selection(selection int32) StateProducer {
	...
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendYesNo(l, c, m.String(), r.Validate(selection, itemId), r.ShouldNotBeBad)
	}
}

func (r StaffSeargantCharlie) Validate(selection int32, itemId uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r StaffSeargantCharlie) AreYouSure(itemId uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
...
func (r StaffSeargantCharlie) InventoryFull(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Your use and etc. inventory seems to be full. You need the free spaces to trade with me! Make room, and then find me.")
	return SendOk(l, c, m.String())
}

func (r StaffSeargantCharlie) WhatDoYouThink(itemId uint32, prize CharliesPrize) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
			AddText("For your ").
			BlueText().AddText("100 ").
