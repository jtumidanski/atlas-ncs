...
func (r MuLungDojoBulletinBoard) Initial(l logrus.FieldLogger, c Context) State {
...
func (r MuLungDojoBulletinBoard) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.Challenge
	case 1:
...
func (r MuLungDojoBulletinBoard) Challenge(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNo(l, c, m.String(), r.Warp, r.No)
}

func (r MuLungDojoBulletinBoard) No(l logrus.FieldLogger, c Context) State {
...
func (r MuLungDojoBulletinBoard) Detail(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.CallYourFriends)
}

func (r MuLungDojoBulletinBoard) CallYourFriends(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendPrevious(l, c, m.String(), r.Detail)
}
