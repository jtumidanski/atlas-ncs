...
func (r Phil) Initial(l logrus.FieldLogger, c Context) State {
	return r.WouldYouLikeTo(l, c)
}

func (r Phil) WouldYouLikeTo(l logrus.FieldLogger, c Context) State {
	...
	return SendNextExit(l, c, m.String(), r.Confused, r.MoreToDo)
}
...
func (r Phil) MoreToDo(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Phil) ConfusedResult(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Phil) SelectTownInfo(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.LithFirst
	case 1:
...
func (r Phil) LithFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextExit(l, c, m.String(), r.LithSecond, r.MoreToDo)
}

func (r Phil) LithSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.LithThird, r.LithFirst, r.MoreToDo)
}

func (r Phil) LithThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.LithSecond, r.MoreToDo)
}

func (r Phil) PerionFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextExit(l, c, m.String(), r.PerionSecond, r.MoreToDo)
}

func (r Phil) PerionSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.PerionThird, r.PerionFirst, r.MoreToDo)
}

func (r Phil) PerionThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.PerionSecond, r.MoreToDo)
}

func (r Phil) ElliniaFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Alright I'll explain to you more about ").
	...
	return SendNextExit(l, c, m.String(), r.ElliniaSecond, r.MoreToDo)
}

func (r Phil) ElliniaSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.ElliniaThird, r.ElliniaFirst, r.MoreToDo)
}

func (r Phil) ElliniaThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("If you want to be a ").
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.ElliniaSecond, r.MoreToDo)
}

func (r Phil) HenesysFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Alright I'll explain to you more about ").
	...
	return SendNextExit(l, c, m.String(), r.HenesysSecond, r.MoreToDo)
}

func (r Phil) HenesysSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.HenesysThird, r.HenesysFirst, r.MoreToDo)
}

func (r Phil) HenesysThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("If you want to be a ").
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.HenesysSecond, r.MoreToDo)
}

func (r Phil) KerningCityFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Alright I'll explain to you more about ").
	...
	return SendNextExit(l, c, m.String(), r.KerningCitySecond, r.MoreToDo)
}

func (r Phil) KerningCitySecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.KerningCityThird, r.KerningCityFirst, r.MoreToDo)
}

func (r Phil) KerningCityThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("If you want to be a ").
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.KerningCitySecond, r.MoreToDo)
}

func (r Phil) NautalisFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextExit(l, c, m.String(), r.NautalisSecond, r.MoreToDo)
}

func (r Phil) NautalisSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		ShowMap(120000000).
	...
	return SendNextPreviousExit(l, c, m.String(), r.NautalisThird, r.NautalisFirst, r.MoreToDo)
}

func (r Phil) NautalisThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.NautalisSecond, r.MoreToDo)
}

func (r Phil) SleepywoodFirst(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Alright I'll explain to you more about ").
	...
	return SendNextExit(l, c, m.String(), r.SleepywoodSecond, r.MoreToDo)
}

func (r Phil) SleepywoodSecond(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.SleepywoodThird, r.SleepywoodFirst, r.MoreToDo)
}

func (r Phil) SleepywoodThird(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.SleepywoodFourth, r.SleepywoodSecond, r.MoreToDo)
}

func (r Phil) SleepywoodFourth(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPreviousExit(l, c, m.String(), r.Confused, r.SleepywoodThird, r.MoreToDo)
}

func (r Phil) SelectTownConfirm(beginner bool) func(selection int32) StateProducer {
...
func (r Phil) ConfirmMap(mapId uint32, cost uint32) StateProducer {
	m := message.NewBuilder().
	...
	return func(l logrus.FieldLogger, c Context) State {
		return SendYesNoExit(l, c, m.String(), r.PerformTransaction(mapId, cost), r.MoreToDo, r.MoreToDo)
	}
}

func (r Phil) ConfirmPerion(cost uint32) StateProducer {
	return r.ConfirmMap(_map.Perion, cost)
}

func (r Phil) ConfirmEllinia(cost uint32) StateProducer {
	return r.ConfirmMap(_map.Ellinia, cost)
}

func (r Phil) ConfirmHenesys(cost uint32) StateProducer {
	return r.ConfirmMap(_map.Henesys, cost)
}

func (r Phil) ConfirmKerningCity(cost uint32) StateProducer {
	return r.ConfirmMap(_map.KerningCity, cost)
}

func (r Phil) ConfirmNautalis(cost uint32) StateProducer {
	return r.ConfirmMap(_map.Nautalis, cost)
}

func (r Phil) PerformTransaction(mapId uint32, cost uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
