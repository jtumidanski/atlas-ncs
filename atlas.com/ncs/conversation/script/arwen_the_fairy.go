...
func (r ArwenTheFairy) Initial(l logrus.FieldLogger, c Context) State {
...
func (r ArwenTheFairy) HelloMaker(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.WhatToMake)
}

func (r ArwenTheFairy) HelloStranger(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r ArwenTheFairy) ProcessMake(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r ArwenTheFairy) ConfirmMoonRock(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNoExit(l, c, m.String(), r.ValidateMoonRock, r.WhatToMake, r.GetMaterialsReady(item.MoonRock))
}

func (r ArwenTheFairy) ConfirmStarRock(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNoExit(l, c, m.String(), r.ValidateStarRock, r.WhatToMake, r.GetMaterialsReady(item.StarRock))
}

func (r ArwenTheFairy) ConfirmBlackFeather(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNoExit(l, c, m.String(), r.ValidateBlackFeather, r.WhatToMake, r.GetMaterialsReady(item.BlackFeather))
}

func (r ArwenTheFairy) ValidateMoonRock(l logrus.FieldLogger, c Context) State {
	return r.Validate(item.MoonRock, r.MoonRockRequirements())(l, c)
}

func (r ArwenTheFairy) ValidateStarRock(l logrus.FieldLogger, c Context) State {
	return r.Validate(item.StarRock, r.StarRockRequirements())(l, c)
}

func (r ArwenTheFairy) ValidateBlackFeather(l logrus.FieldLogger, c Context) State {
...
func (r ArwenTheFairy) Validate(itemId uint32, requirements ArwenRequirements) StateProducer {
...
func (r ArwenTheFairy) MoreMeso(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Are you sure you have enough mesos?")
	return SendOk(l, c, m.String())
}

func (r ArwenTheFairy) NeedMoreOfItem(itemId uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
...
func (r ArwenTheFairy) Success(itemId uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
...
func (r ArwenTheFairy) GetMaterialsReady(itemId uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
