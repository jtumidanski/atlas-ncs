...
func (r Wisp) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.WhoAreYou
	case 1:
...
func (r Wisp) WhoAreYou(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Wisp) MoreAboutPets(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.But)
}

func (r Wisp) HowToRaise(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.Talk)
}

func (r Wisp) DoPetsDie(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Wisp) Kitty(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Puppy(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Bunny(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) MiniCargo(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Husky(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) BlackPig(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Panda(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Dino(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Rudolph(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Monkey(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Robot(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Elephant(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) GoldenPig(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Penguin(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) MiniYeti(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) JrBalrog(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) BabyDragon(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) GreenRedBlueDragon(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) BlackDragon(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Snowman(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) SunWuKong(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) JrReaper(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) CrystalRudolph(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Kino(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) WhiteDuck(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) PinkBean(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) Porcupine(l logrus.FieldLogger, c Context) State {
...
func (r Wisp) But(l logrus.FieldLogger, c Context) State {
	...
	return SendNextPrevious(l, c, m.String(), r.SpecialCommands, r.MoreAboutPets)
}

func (r Wisp) SpecialCommands(l logrus.FieldLogger, c Context) State {
	...
	return SendPrevious(l, c, m.String(), r.But)
}

func (r Wisp) Talk(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), r.HowToRaise, r.Hungry)
}

func (r Wisp) Hungry(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), r.NotNormalFood, r.Talk)
}

func (r Wisp) NotNormalFood(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), r.GoesHome, r.Hungry)
}

func (r Wisp) GoesHome(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendPrevious(l, c, m.String(), r.NotNormalFood)
}

func (r Wisp) AfterSomeTime(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), r.Sad, r.GoesHome)
}

func (r Wisp) Sad(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendPrevious(l, c, m.String(), r.AfterSomeTime)
}
