...
func (r WarriorJobInstructor) Initial(l logrus.FieldLogger, c Context) State {
...
func (r WarriorJobInstructor) TrueHero(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("You're truly a hero!")
	return SendOk(l, c, m.String())
}

func (r WarriorJobInstructor) LetYouIn(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) SendYou(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) AcquireMarble(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) CannotLeave(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r WarriorJobInstructor) Begin(l logrus.FieldLogger, c Context) State {
...
func (r WarriorJobInstructor) OnceYouAreReady(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
