...
func (r FranzTheOwner) Initial(l logrus.FieldLogger, c Context) State {
	return r.Hello(l, c)
}

func (r FranzTheOwner) Hello(l logrus.FieldLogger, c Context) State {
...
func (r FranzTheOwner) Selection(selection int32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendStyle(l, c, m.String(), r.ProcessSelection(faces), faces)
	}
}
...
func (r FranzTheOwner) ProcessSelection(options []uint32) ProcessSelection {
...
func (r FranzTheOwner) MissingCoupon(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r FranzTheOwner) PerformChange(choice uint32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r FranzTheOwner) Enjoy(l logrus.FieldLogger, c Context) State {
