...
func (r Weaver) Initial(l logrus.FieldLogger, c Context) State {
	...
	return SendYesNo(l, c, m.String(), r.Continue, r.TooBusy)
}

func (r Weaver) TooBusy(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Hmmm ... too busy to do it right now? If you feel like doing it, though, come back and find me.")
	return SendOk(l, c, m.String())
}

func (r Weaver) Continue(l logrus.FieldLogger, c Context) State {
...
func (r Weaver) HereIsTheLetter(l logrus.FieldLogger, c Context) State {
...
func (r Weaver) Info(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
