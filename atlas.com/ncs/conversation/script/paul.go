...
func (r Paul) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Paul) WhatKind(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Paul) AllThisMonth(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Explanation(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Game(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.OlaOla
	case 1:
...
func (r Paul) Go(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) OlaOla(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Fitness(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Snowball(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) Coconut(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) OxQuiz(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Paul) TreasureHunt(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
