...
func (r Tony) Initial(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.WhatKind)
}

func (r Tony) WhatKind(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Tony) AllThisMonth(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Explanation(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Game(selection int32) StateProducer {
	switch selection {
	case 0:
		return r.OlaOla
	case 1:
...
func (r Tony) Go(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) OlaOla(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Fitness(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Snowball(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) Coconut(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) OxQuiz(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Tony) TreasureHunt(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
