...
func (r Eckhart) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Eckhart) NotNightWalker(l logrus.FieldLogger, c Context) State {
...
func (r Eckhart) FoundMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Eckhart) Trigger(l logrus.FieldLogger, c Context) State {
