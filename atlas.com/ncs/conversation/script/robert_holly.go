...
func (r RobertHolly) Initial(l logrus.FieldLogger, c Context) State {
	...
	return SendYesNo(l, c, m.String(), r.Alright, r.ISee)
}

func (r RobertHolly) ISee(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r RobertHolly) Alright(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNo(l, c, m.String(), r.Validate, r.NotAsManyFriends)
}

func (r RobertHolly) Validate(l logrus.FieldLogger, c Context) State {
...
func (r RobertHolly) AreYouSure(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r RobertHolly) Process(l logrus.FieldLogger, c Context) State {
...
func (r RobertHolly) NotAsManyFriends(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
