...
// HarpStringC is located in Hidden Street - Eliza's Garden (920020000)
type HarpStringC struct {
}

func (r HarpStringC) NPCId() uint32 {
	return npc.HarpStringC
}

var HarpSounds = []string{"do", "re", "mi", "pa", "sol", "la", "si"}
var HarpSong = "CCGGAAGFFEEDDC|GGFFEED|GGFFEED|CCGGAAGFFEEDDC|"

func (r HarpStringC) Initial(l logrus.FieldLogger, c Context) State {
