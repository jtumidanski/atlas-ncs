...
func (r Irena) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Irena) NotWindArcher(l logrus.FieldLogger, c Context) State {
...
func (r Irena) FoundMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Irena) Trigger(l logrus.FieldLogger, c Context) State {
