...
func (r Mimo) Initial(l logrus.FieldLogger, c Context) State {
	return r.Hello(l, c)
}

func (r Mimo) Hello(l logrus.FieldLogger, c Context) State {
...
func (r Mimo) Selection(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r Mimo) UnderShinsoo(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.AskAnyTime)
}

func (r Mimo) AskAnyTime(l logrus.FieldLogger, c Context) State {
	...
	return SendNextPrevious(l, c, m.String(), Exit(), r.UnderShinsoo)
}

func (r Mimo) Hint(hint uint32) StateProducer {
...
func (r Mimo) CygnusInfo(l logrus.FieldLogger, c Context) State {
