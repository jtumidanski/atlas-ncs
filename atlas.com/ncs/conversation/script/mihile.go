...
func (r Mihile) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Mihile) NotDawnWarrior(l logrus.FieldLogger, c Context) State {
...
func (r Mihile) FoundMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Mihile) Trigger(l logrus.FieldLogger, c Context) State {
