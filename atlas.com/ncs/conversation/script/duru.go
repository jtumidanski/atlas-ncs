...
func (r Duru) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Duru) Selection(selection int32) StateProducer {
...
func (r Duru) NeedAtLeast100(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("You don't have enough... I need at least 100.")
	return SendOk(l, c, m.String())
}

func (r Duru) ProcessQuantity(selection int32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		if selection <= 0 {
