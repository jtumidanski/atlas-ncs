...
func (r BossKitty) Initial(l logrus.FieldLogger, c Context) State {
	if character.QuestStarted(l)(c.CharacterId, 8012) && !character.HasItem(l)(c.CharacterId, item.OrangeMarble) {
		...
		return SendYesNo(l, c, m.String(), r.ValidateChicken, Exit())
	} else {
...
func (r BossKitty) ValidateChicken(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.FirstQuestion)
}

func (r BossKitty) MissingChicken(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r BossKitty) FirstQuestion(l logrus.FieldLogger, c Context) State {
...
func (r BossKitty) AskQuestion(num int, questions []Question) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendListSelection(l, c, m.String(), r.Validate(num, question, append(questions[:selected], questions[selected+1:]...)))
	}
}

func (r BossKitty) Validate(num int, question Question, remaining []Question) ProcessSelection {
...
func (r BossKitty) AllCorrect(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
