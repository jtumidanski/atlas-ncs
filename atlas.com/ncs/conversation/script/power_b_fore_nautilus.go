...
func (r PowerBForeNautilus) Initial(l logrus.FieldLogger, c Context) State {
...
func (r PowerBForeNautilus) UnderLevel20(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("This training ground is available only for those under level 20.")
	return SendOk(l, c, m.String())
}

func (r PowerBForeNautilus) Warp(mapId uint32) StateProducer {
...
func (r PowerBForeNautilus) ChooseRoom(l logrus.FieldLogger, c Context) State {
...
func (r PowerBForeNautilus) RoomSelection(selection int32) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
...
func (r PowerBForeNautilus) RoomFull(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
