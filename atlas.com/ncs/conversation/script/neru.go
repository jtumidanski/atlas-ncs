...
func (r Neru) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Neru) BrothersLeter(l logrus.FieldLogger, c Context) State {
...
func (r Neru) Validate(l logrus.FieldLogger, c Context) State {
...
func (r Neru) GetOutOfHere(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Neru) RaiseCloseness(l logrus.FieldLogger, c Context) State {
	character.GainItem(l)(c.CharacterId, item.WeaversLetter, -1)
	character.GainCloseness(l)(c.CharacterId, 4)
	return r.TrainAgain(l, c)
}

func (r Neru) TrainAgain(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Neru) Chill(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
