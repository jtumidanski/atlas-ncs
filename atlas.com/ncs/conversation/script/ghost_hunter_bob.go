...
func (r GhostHunterBob) Initial(l logrus.FieldLogger, c Context) State {
...
func (r GhostHunterBob) Hello(l logrus.FieldLogger, c Context) State {
...
func (r GhostHunterBob) TakeIt(l logrus.FieldLogger, c Context) State {
