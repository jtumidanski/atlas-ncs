...
func (r DancesWithBalrog) ChosenWisely(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("You have chosen wisely.")
	return SendOk(l, c, m.String())
}

func (r DancesWithBalrog) FirstJob(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.ValidateFirstJobCriteria)
}

func (r DancesWithBalrog) ValidateFirstJobCriteria(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrog) TrainMore(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r DancesWithBalrog) ImportantChoice(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("It is an important and final choice. You will not be able to turn back.")
	return SendNextPreviousExit(l, c, m.String(), r.ProcessFirstJob, r.FirstJob, r.MakeUpYourMind)
}

func (r DancesWithBalrog) MakeUpYourMind(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Make up your mind and visit me again.")
	return SendOk(l, c, m.String())
}

func (r DancesWithBalrog) ProcessFirstJob(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrog) MakeInventoryRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Make some room in your inventory and talk back to me.")
	return SendNext(l, c, m.String(), Exit())
}

func (r DancesWithBalrog) FirstJobAdvance(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.GottenStronger)
}

func (r DancesWithBalrog) GottenStronger(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), r.Reminder, r.FirstJobAdvance)
}

func (r DancesWithBalrog) Reminder(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), Exit(), r.GottenStronger)
}

func (r DancesWithBalrog) SecondJob(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrog) ChooseAPath(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.PathInfo)
}

func (r DancesWithBalrog) GoAndSee(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r DancesWithBalrog) Astonishing(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("The progress you have made is astonishing.")
	return SendNext(l, c, m.String(), r.GoodDecision)
}

func (r DancesWithBalrog) GoodDecision(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNext(l, c, m.String(), r.GiveLetter)
}

func (r DancesWithBalrog) GiveLetter(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrog) MakeSpace(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r DancesWithBalrog) PathInfoSelected(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r DancesWithBalrog) FighterInfo(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextExit(l, c, m.String(), r.PathInfo, r.MakeUpYourMind)
}

func (r DancesWithBalrog) PageInfo(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Warriors that master ").
...
func (r DancesWithBalrog) SpearmanInfo(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Warriors that master ").
...
func (r DancesWithBalrog) PathSelected(selection int32) StateProducer {
	switch selection {
	case 0:
...
func (r DancesWithBalrog) SecondJobConfirmation(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendYesNoExit(l, c, m.String(), r.SecondJobAdvance(jobId, jobName), r.PathSelection, r.MakeUpYourMind)
	}
}

func (r DancesWithBalrog) SecondJobAdvance(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		if character.HasItem(l)(c.CharacterId, item.ProofOfHero) {
...
func (r DancesWithBalrog) SecondJobSuccess(jobId uint16, jobName string) StateProducer {
	switch jobId {
	case job.Fighter:
...
func (r DancesWithBalrog) FighterSuccess(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
		...
		return SendNext(l, c, m.String(), r.BookGiven(jobId, jobName))
	}
}

func (r DancesWithBalrog) PageSuccess(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
...
func (r DancesWithBalrog) SpearmanSuccess(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
			AddText("Alright, you have now become the ").
...
func (r DancesWithBalrog) BookGiven(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
		...
		return SendNextPrevious(l, c, m.String(), r.SPGiven(jobId, jobName), r.SecondJobSuccess(jobId, jobName))
	}
}

func (r DancesWithBalrog) SPGiven(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
		...
		return SendNextPrevious(l, c, m.String(), r.BecomeStrong(jobId, jobName), r.BookGiven(jobId, jobName))
	}
}

func (r DancesWithBalrog) BecomeStrong(jobId uint16, jobName string) StateProducer {
	return func(l logrus.FieldLogger, c Context) State {
		m := message.NewBuilder().
			AddText(jobName).
		...
		return SendNextPrevious(l, c, m.String(), Exit(), r.SPGiven(jobId, jobName))
	}
}
