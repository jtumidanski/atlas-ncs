...
func (r Joel) Initial(l logrus.FieldLogger, c Context) State {
	return r.Hello(l, c)
}

func (r Joel) Hello(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		...
		BlackText().AddText("?")
	return SendYesNo(l, c, m.String(), r.ValidatePurchase, r.MoreToDo)
}

func (r Joel) ValidatePurchase(l logrus.FieldLogger, c Context) State {
...
func (r Joel) ProcessPurchase(l logrus.FieldLogger, c Context) State {
...
func (r Joel) PurchaseFailed(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Joel) MoreToDo(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
