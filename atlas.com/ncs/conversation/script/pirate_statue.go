...
func (r PirateStatue) Initial(l logrus.FieldLogger, c Context) State {
...
func (r PirateStatue) ComeBack(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r PirateStatue) Warp(l logrus.FieldLogger, c Context) State {
	return WarpById(_map.NavigationRoom, 0)(l, c)
}