...
func (r DancesWithBalrogDemo) Initial(l logrus.FieldLogger, c Context) State {
	return r.WarriorIntroduction(l, c)
}

func (r DancesWithBalrogDemo) WarriorIntroduction(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrogDemo) Demo(l logrus.FieldLogger, c Context) State {
...
func (r DancesWithBalrogDemo) DoDemo(l logrus.FieldLogger, c Context) State {
    npc.Processor(l).LockUI()

    err := npc.Processor(l).WarpById(c.WorldId, c.ChannelId, c.CharacterId, _map.WarriorDemo, 0)
    if err != nil {
...
func (r DancesWithBalrogDemo) SeeMeAgain(l logrus.FieldLogger, c Context) State {
