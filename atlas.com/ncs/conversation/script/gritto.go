...
func (r Gritto) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Gritto) IfIMust(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Gritto) Advance(l logrus.FieldLogger, c Context) State {
...
func (r Gritto) MakeRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Gritto) Selection(_ int32) StateProducer {
...
func (r Gritto) ItIsDone(l logrus.FieldLogger, c Context) State {
