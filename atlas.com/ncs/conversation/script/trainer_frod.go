...
func (r TrainerFrod) Initial(l logrus.FieldLogger, c Context) State {
...
func (r TrainerFrod) BrothersLetter(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.Action)
}

func (r TrainerFrod) BrotherToldMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r TrainerFrod) Action(l logrus.FieldLogger, c Context) State {
...
func (r TrainerFrod) CompleteCourseNoPets(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendNextPrevious(l, c, m.String(), Exit(), r.BrothersLetter)
}

func (r TrainerFrod) CompleteCourse(l logrus.FieldLogger, c Context) State {
