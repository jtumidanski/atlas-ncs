...
func (r Hawkeye) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Hawkeye) NotBlazeWizard(l logrus.FieldLogger, c Context) State {
...
func (r Hawkeye) FoundMe(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Hawkeye) Trigger(l logrus.FieldLogger, c Context) State {
