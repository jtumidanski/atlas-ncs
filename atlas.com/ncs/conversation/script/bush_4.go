...
func (r Bush4) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Bush4) PileOfBoxes(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Just a pile of boxes, nothing special...")
	return SendOk(l, c, m.String())
}

func (r Bush4) DoYouWant(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Do you want to obtain a glasses?")
	return SendNext(l, c, m.String(), r.Validate)
}

func (r Bush4) Validate(l logrus.FieldLogger, c Context) State {
...
func (r Bush4) AlreadyHave(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("You ").
...
func (r Bush4) NoInventoryRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
