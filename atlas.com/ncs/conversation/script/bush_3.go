...
// Bush3 is located in Victoria Road - Nautilus Harbor (120000000)
type Bush3 struct {
}

func (r Bush3) NPCId() uint32 {
	return npc.Bush3
}

func (r Bush3) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Bush3) PileOfBoxes(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Just a pile of boxes, nothing special...")
	return SendOk(l, c, m.String())
}

func (r Bush3) DoYouWant(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("Do you want to obtain a glasses?")
	return SendNext(l, c, m.String(), r.Validate)
}

func (r Bush3) Validate(l logrus.FieldLogger, c Context) State {
...
func (r Bush3) AlreadyHave(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
		AddText("You ").
...
func (r Bush3) NoInventoryRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
