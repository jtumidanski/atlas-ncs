...
func initRegistry() *Registry {
	...
	s.addConversation(discrete.Ari{})
	...
	s.addConversation(discrete.Chico{})
	...
	s.addConversation(discrete.Gordon{})
	...
	s.addConversation(discrete.Jimmy{})
	s.addConversation(discrete.Jiyur{})
	s.addConversation(discrete.JJ{})
	...
	s.addConversation(discrete.Kelvin{})
	...
	s.addConversation(discrete.Mani{})
	...
	s.addConversation(discrete.Miranda{})
	...
	s.addConversation(discrete.Muhamad{})
	...
	s.addConversation(discrete.Nerbit{})
	s.addConversation(discrete.Neru{})
	s.addConversation(discrete.Neve{})
	s.addConversation(discrete.NLCTaxi{})
	s.addConversation(discrete.Noel{})
	...
	s.addConversation(discrete.Rydole{})
	...
	s.addConversation(discrete.Sarah{})
	...
	s.addConversation(discrete.Serryl{})
	...
	s.addConversation(discrete.Sixx{})
	...
	s.addConversation(discrete.Tara{})
	...
	s.addConversation(discrete.VIsage{})
	...
	s.addConversation(discrete.Vogen{})
