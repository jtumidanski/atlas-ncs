...
func (r HolyStone) Initial(l logrus.FieldLogger, c Context) State {
...
func (r HolyStone) BringMe(l logrus.FieldLogger, c Context) State {
...
func (r HolyStone) InventoryRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("Have a free ETC slot available before accepting this trial.")
	return SendNext(l, c, m.String(), Exit())
}

func (r HolyStone) Alright(l logrus.FieldLogger, c Context) State {
	...
	return SendNext(l, c, m.String(), r.TakeCrystal)
}

func (r HolyStone) TakeCrystal(l logrus.FieldLogger, c Context) State {
...
func (r HolyStone) AskQuestion(set []uint32) StateProducer {
	if len(set) == 0 {
		return Exit()
	}
	return func(l logrus.FieldLogger, c Context) State {
		...
		return SendListSelection(l, c, m.String(), r.ProcessAnswer(set))
	}
}
...
func (r HolyStone) ProcessAnswer(set []uint32) ProcessSelection {
...
func (r HolyStone) Failed(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().AddText("You have failed the question.")
	return SendOk(l, c, m.String())
}

func (r HolyStone) Complete(l logrus.FieldLogger, c Context) State {
