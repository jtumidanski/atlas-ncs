...
func (r Samuel) Initial(l logrus.FieldLogger, c Context) State {
...
func (r Samuel) IfIMust(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Samuel) Advance(l logrus.FieldLogger, c Context) State {
...
func (r Samuel) MakeRoom(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r Samuel) Selection(_ int32) StateProducer {
...
func (r Samuel) ItIsDone(l logrus.FieldLogger, c Context) State {
