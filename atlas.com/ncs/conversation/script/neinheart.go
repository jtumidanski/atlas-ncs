...
// Neinheart is located in Opening - Cygnus Knights (913040006)
type Neinheart struct {
}

func (r Neinheart) NPCId() uint32 {
	return npc.Neinheart
}
...
func (r Neinheart) WarpToEreve(l logrus.FieldLogger, c Context) State {
	return r.Warp(_map.Ereve)(l, c)
}

func (r Neinheart) WarpBack(l logrus.FieldLogger, c Context) State {
	mapId := character.SavedLocation(l)(c.CharacterId, "CYGNUSINTRO")
	return r.Warp(mapId)(l, c)
}

func (r Neinheart) Warp(mapId uint32) StateProducer {
