...
func (r MrGoldstein) Initial(l logrus.FieldLogger, c Context) State {
	return r.ExtendBuddyList(l, c)
}

func (r MrGoldstein) ExtendBuddyList(l logrus.FieldLogger, c Context) State {
	...
	return SendYesNo(l, c, m.String(), r.OkGood, r.QuickExit)
}

func (r MrGoldstein) QuickExit(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r MrGoldstein) OkGood(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
	...
	return SendYesNo(l, c, m.String(), r.ConfirmPayment, r.Exit)
}

func (r MrGoldstein) Exit(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r MrGoldstein) ConfirmPayment(l logrus.FieldLogger, c Context) State {
...
func (r MrGoldstein) AreYouSure(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r MrGoldstein) ProcessPayment(l logrus.FieldLogger, c Context) State {
...
func (r MrGoldstein) SendSuccess(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
...
func (r MrGoldstein) Error(l logrus.FieldLogger, c Context) State {
	m := message.NewBuilder().
